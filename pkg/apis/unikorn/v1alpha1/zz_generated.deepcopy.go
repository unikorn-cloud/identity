...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OrganizationProviderSpec) DeepCopyInto(out *OrganizationProviderSpec) {
	*out = *in
	if in.Google != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OrganizationProviderSpec.
func (in *OrganizationProviderSpec) DeepCopy() *OrganizationProviderSpec {
	if in == nil {
		return nil
	}
	out := new(OrganizationProviderSpec)
	in.DeepCopyInto(out)
	return out
}
